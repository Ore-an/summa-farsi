...
if ! $skip_scoring ; then
  run.pl LMWT=8:12 $outdir/scoring/log/best_path.LMWT.log local/get_ctm.sh --stm data/summa/stm --glm data/summa/glm LMWT 0.0 $newlang $data $dir/final.mdl $outdir
fi

grep Sum $outdir/score*/*/*.sys
exit 0;
